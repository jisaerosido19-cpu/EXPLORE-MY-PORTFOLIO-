...
<title>Jisa Erosido | Portfolio</title>
...
.output-box a{color:#007bff;text-decoration:none;}
...
<header>
  <h1>Jisa Erosido</h1>
  <p>Aspiring IT Professional & Creative Designer</p>
</header>
...
<nav>
  ...
  <a href="#contact">Contact</a>
    ...
    <h2>Hello Welcome! 👋</h2>    
    <p>where creativity meets purpose. Explore my works, projects, and designs built with passion and heart. 🌷</p>    
    <p class="quote">“Creativity is not just about design — it’s about turning vision into reality.”</p>    
</section>
...
<section id="resume" class="resume">
    ...
    <div class="resume-container">
        <p>Interested in working together? Take a look at my credentials below.</p>
        ...
        <div class="resume-btns">
            ...
            <a href="Jisa_Resume.pdf"
               download="Jisa_Erosido_Resume.pdf"
               class="cv-btn download-cv-btn">
...
<section id="tutorials">
  ...
  <div class="video-container">
    ...
    <div class="tutorial" data-video="https://www.youtube.com/embed/vecnvtvWmXk?autoplay=1">
      ...
      <p>Figma Video Editing Tutorial</p>
    </div>
...
<section id="contact">
    <div class="glass-card">
        ...
        <form action="mailto:jisaerosido@gmail.com" method="post" enctype="text/plain">
...
<footer>
    <p>Jisa Erosido | © 2026 Designed with 💜 Passion & Code</p>
</footer>
...
<figure><img src="jem.jpg"></figure>
<figure><img src="IMG_20251030_171857.jpg"></figure>
<figure><img src="IMG_20251030_171815.jpg"></figure>
</div>
</section>

<!-- TUTORIALS (CLICK PLAY VIDEO) -->
<section id="tutorials">
